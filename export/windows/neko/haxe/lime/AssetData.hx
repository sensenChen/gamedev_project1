...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/voice recordings/Before Boss 1.1.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Fail 1.3.wav", "assets/voice recordings/Fail 1.3.wav");
			type.set ("assets/voice recordings/Fail 1.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Fail 2.3.wav", "assets/voice recordings/Fail 2.3.wav");
			type.set ("assets/voice recordings/Fail 2.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Fail 3.3.wav", "assets/voice recordings/Fail 3.3.wav");
			type.set ("assets/voice recordings/Fail 3.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Intro Clip 1.3.wav", "assets/voice recordings/Intro Clip 1.3.wav");
			type.set ("assets/voice recordings/Intro Clip 1.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Intro Clip 2.3.wav", "assets/voice recordings/Intro Clip 2.3.wav");
			type.set ("assets/voice recordings/Intro Clip 2.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Intro Clip 3.3.wav", "assets/voice recordings/Intro Clip 3.3.wav");
			type.set ("assets/voice recordings/Intro Clip 3.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Win 1.3.wav", "assets/voice recordings/Win 1.3.wav");
			type.set ("assets/voice recordings/Win 1.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Win 2.3.wav", "assets/voice recordings/Win 2.3.wav");
			type.set ("assets/voice recordings/Win 2.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/voice recordings/Win 3.3.wav", "assets/voice recordings/Win 3.3.wav");
			type.set ("assets/voice recordings/Win 3.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
