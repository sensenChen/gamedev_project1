...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/recording/Before Boss 1.1.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/recording/Fail 1.3.wav", "assets/recording/Fail 1.3.wav");
			type.set ("assets/recording/Fail 1.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/recording/Fail 2.3.wav", "assets/recording/Fail 2.3.wav");
			type.set ("assets/recording/Fail 2.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/recording/Fail 3.3.wav", "assets/recording/Fail 3.3.wav");
			type.set ("assets/recording/Fail 3.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			...
			type.set ("assets/recording/Win 1.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/recording/Win 2.3.wav", "assets/recording/Win 2.3.wav");
			type.set ("assets/recording/Win 2.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
			path.set ("assets/recording/Win 3.3.wav", "assets/recording/Win 3.3.wav");
			type.set ("assets/recording/Win 3.3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
