...
typedef Config = {
	var playerX:Int;
	var playerY:Int;
	var heartX:Array<Int>;
	var heartY:Array<Int>;
	var enemyX:Array<Int>;
	var enemyY:Array<Int>;
	var dsp:Array<Array<Int> >;
...
class PlayState extends FlxState
{
	...
	{	
		...
		for (i in 0...10) {
			...
			_enemy = new Enemy(data.enemyY[i]*tilesize, data.enemyX[i]*tilesize, newpath, 0, tilesize);
